...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    Role: typeof import('./src/components/background/layout/menu/item/role.vue')['default']
    RouterLink: typeof import('vue-router')['RouterLink']
    RouterView: typeof import('vue-router')['RouterView']
    User: typeof import('./src/components/background/layout/menu/item/user.vue')['default']
  }
}
